...
def main():
    ...
    parser.add_argument("--out", "-o", dest="output_path", default="data/lab04/report.csv")
    ...
    try:
        ...
        print(f"Ошибка: невозможно прочитать файл с кодировкой {args.encoding}", file=sys.stderr)
        sys.exit(1)
