...
def main() -> None:
    parser = argparse.ArgumentParser(description="CLI-утилиты, конвертирующие файлы JSON/CSV/XLSX")
    ...
    json2csv.add_argument("--out", dest="output", required=True, help="Путь к output-CSV")
    ...
    csv2json.add_argument("--out", dest="output", required=True, help="Путь к output-JSON")
    ...
    csv2xlsx.add_argument("--out", dest="output", required=True, help="Путь к output-XLSX")
